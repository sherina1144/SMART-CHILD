...
<head>
    ...
    <title>Login - Smart Child</title>
    <!-- Menggunakan Tailwind CSS CDN atau sesuaikan dengan aset Anda -->
...
<body class="flex items-center justify-center min-h-screen bg-slate-50">
    ...
    <div class="w-full max-w-md p-8 bg-white rounded-2xl login-card border border-slate-100">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-slate-800">Selamat Datang 👋</h1>
            <p class="text-sm text-slate-500 mt-1">Silakan masuk ke akun Smart Child Anda</p>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-xs text-slate-400">Smart Child System &copy; 2026</p>
        </div>
    </div>
