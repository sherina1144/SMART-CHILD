...
<div class="page-container">
    ...
    <div class="page-header">
        <div>
            <h1>Tambah Smart Child Box</h1>
            <p>Tambahkan paket Smart Child Box beserta produk di dalamnya.</p>
        </div>

        <a href="{{ route('admin.smartbox.index') }}" class="btn-secondary">
    ...
    <form
        action="{{ route('admin.smartbox.store') }}"
        method="POST"
        ...
        <div class="form-card">
            ...
            <div class="form-card-title">
                ...
                <div>
                    ...
                    <p>Masukkan informasi utama paket.</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="0 - 2 Tahun"
                            {{ old('kategori_usia') == '0 - 2 Tahun' ? 'selected' : '' }}
                        >
                            0 - 2 Tahun
                        </option>
                        ...
                        <option
                            value="3 - 5 Tahun"
                            {{ old('kategori_usia') == '3 - 5 Tahun' ? 'selected' : '' }}
                        >
                            3 - 5 Tahun
                        </option>
                        ...
                        <option
                            value="6 - 8 Tahun"
                            {{ old('kategori_usia') == '6 - 8 Tahun' ? 'selected' : '' }}
                        >
                            6 - 8 Tahun
                        </option>
                        ...
                        <option
                            value="9 - 12 Tahun"
                            {{ old('kategori_usia') == '9 - 12 Tahun' ? 'selected' : '' }}
                        >
                            9 - 12 Tahun
                        </option>
                    </select>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea
                        ...
                        name="deskripsi"
                        rows="4"
                        placeholder="Masukkan deskripsi Smart Child Box..."
        ...
        <div class="form-card">
            ...
            <div class="form-card-title">
                ...
                <div>
                    ...
                    <p>
                        Pilih produk yang menjadi bagian dari paket.
                    </p>
                </div>
...
<script>
    ...
    function addProductRow() {
        ...
        row.innerHTML = `
            ...
            <div class="form-group unit-field">
                ...
                <select name="products[${productIndex}][satuan]">
    ...
    function updateProductNumbers() {
        ...
        rows.forEach((row, index) => {
            ...
            const number = row.querySelector('.product-number');
